...
Poly polygons::frame({{0,0},  {0,12}, {12,12}, {12,0}});
Poly polygons::poly1({{0,0},  {3,0},  {2,4}});
Poly polygons::poly2({{3,0},  {3,6},  {2,4}});
...
Poly polygons::poly10({{8,4},  {12,0}, {9,6}});
Poly polygons::poly11({{9,6},  {12,0}, {12,6}});
Poly polygons::poly12({{9,6},  {12,6}, {12,8}});
